...
- [x] **Phase 35: Audit-Fixes & Doc-Hygiene Cleanup** — SSR remove-button fix, `last_heartbeat` leak fix, dead `escHtml()` removal, v4.0/v4.1 frontmatter reconciliation (completed 2026-07-03)
...
- [x] 35-02-PLAN.md — AF-02 raw last_heartbeat scrub from get_status() + SSE frame, with core/cli/status.py lockstep
- [x] 35-03-PLAN.md — DH-01/02/03 v4.0/v4.1 frontmatter reconciliation (validated / nyquist_compliant / requirements:)
