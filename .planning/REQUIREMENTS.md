...
- [x] **SSE-01**: The dashboard receives live status and log updates over a single Server-Sent Events stream (`/api/events`), replacing the 2-second polling loop.
