...
- [x] **REL-07**: `BotService.get_status()` returns a structured per-plugin health surface (liveness, last-activity, last-error) queryable from the CLI and web UI, and sustained degradation is signaled through the notification dispatcher.
